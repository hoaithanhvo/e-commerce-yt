...
import { apiUpdateCurrent, apiUpdateUserNew } from 'apis'
...
const Personal = ({ navigate }) => {
    ...
    const handleUpdateInfor = async (data) => {
        ...
        const response = await apiUpdateUserNew(data)
        ...
        if (response.success) {
            ...
            if (searchParam.get('redirect')) navigate(searchParam.get('redirect'))
